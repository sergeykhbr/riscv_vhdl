...
set OBJ_DIR=%TOP_DIR%dhrystone21/makefiles/obj
set ELF_DIR=%TOP_DIR%dhrystone21/makefiles/bin
...
set OBJ_DIR=%TOP_DIR%dhrystone21/makefiles/objarm
set ELF_DIR=%TOP_DIR%dhrystone21/makefiles/binarm
