...
asic_gencpu64_top::asic_gencpu64_top(sc_module_name name,
                                     bool async_reset,
...
asic_gencpu64_top::~asic_gencpu64_top() {
    if (iclk0) {
        delete iclk0;
    }
    if (iosdcmd0) {
...
void asic_gencpu64_top::generateVCD(sc_trace_file *i_vcd, sc_trace_file *o_vcd) {
    if (o_vcd) {
