...
gencpu64_soc::gencpu64_soc(sc_module_name name,
                           bool async_reset,
    ...
    bus0 = new gencpu64_axictrl_bus0("bus0",
                                      async_reset);
    ...
    bus1 = new gencpu64_axi2apb_bus1("bus1",
                                      async_reset);
...
void gencpu64_soc::generateVCD(sc_trace_file *i_vcd, sc_trace_file *o_vcd) {
    if (o_vcd) {
