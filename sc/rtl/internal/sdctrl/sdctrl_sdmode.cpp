...
void sdctrl_sdmode::generateVCD(sc_trace_file *i_vcd, sc_trace_file *o_vcd) {
    ...
    if (o_vcd) {
        ...
        sc_trace(o_vcd, r.cmd_req_arg, pn + ".r.cmd_req_arg");
        sc_trace(o_vcd, r.cmd_req_rn, pn + ".r.cmd_req_rn");
        sc_trace(o_vcd, r.cmd_resp_cmd, pn + ".r.cmd_resp_cmd");
        sc_trace(o_vcd, r.cmd_resp_arg32, pn + ".r.cmd_resp_arg32");
        sc_trace(o_vcd, r.data_addr, pn + ".r.data_addr");
        sc_trace(o_vcd, r.data_data, pn + ".r.data_data");
        sc_trace(o_vcd, r.data_resp_valid, pn + ".r.data_resp_valid");
        sc_trace(o_vcd, r.wdog_ena, pn + ".r.wdog_ena");
        sc_trace(o_vcd, r.crc16_clear, pn + ".r.crc16_clear");
        sc_trace(o_vcd, r.crc16_calc0, pn + ".r.crc16_calc0");
        sc_trace(o_vcd, r.crc16_calc1, pn + ".r.crc16_calc1");
        sc_trace(o_vcd, r.crc16_calc2, pn + ".r.crc16_calc2");
        sc_trace(o_vcd, r.crc16_calc3, pn + ".r.crc16_calc3");
        sc_trace(o_vcd, r.crc16_rx0, pn + ".r.crc16_rx0");
        sc_trace(o_vcd, r.crc16_rx1, pn + ".r.crc16_rx1");
        sc_trace(o_vcd, r.crc16_rx2, pn + ".r.crc16_rx2");
        sc_trace(o_vcd, r.crc16_rx3, pn + ".r.crc16_rx3");
        sc_trace(o_vcd, r.dat_full_ena, pn + ".r.dat_full_ena");
        sc_trace(o_vcd, r.dat_csn, pn + ".r.dat_csn");
        sc_trace(o_vcd, r.err_clear, pn + ".r.err_clear");
        sc_trace(o_vcd, r.err_valid, pn + ".r.err_valid");
        sc_trace(o_vcd, r.err_code, pn + ".r.err_code");
        sc_trace(o_vcd, r.sck_400khz_ena, pn + ".r.sck_400khz_ena");
        sc_trace(o_vcd, r.sdstate, pn + ".r.sdstate");
        sc_trace(o_vcd, r.initstate, pn + ".r.initstate");
        sc_trace(o_vcd, r.readystate, pn + ".r.readystate");
        sc_trace(o_vcd, r.identstate, pn + ".r.identstate");
        sc_trace(o_vcd, r.wait_cmd_resp, pn + ".r.wait_cmd_resp");
        sc_trace(o_vcd, r.sdtype, pn + ".r.sdtype");
        sc_trace(o_vcd, r.HCS, pn + ".r.HCS");
        sc_trace(o_vcd, r.S18, pn + ".r.S18");
        sc_trace(o_vcd, r.OCR_VoltageWindow, pn + ".r.OCR_VoltageWindow");
...
void sdctrl_sdmode::comb() {
    ...
    v.err_code = 0;
    v.data_resp_valid = 0;
    vb_cmd_req_arg = r.cmd_req_arg.read();
    ...
    if (r.cmd_req_valid.read() == 1) {
        ...
        // Parse Rx response:
        v.wait_cmd_resp = 0;
        v.cmd_resp_cmd = i_cmd_resp_cmd.read();
        v.cmd_resp_arg32 = i_cmd_resp_arg32.read();
        ...
        case IDLESTATE_CMD8:
            ...
            vb_cmd_req_arg(11, 8) = i_cfg_voltage_supply.read();
            vb_cmd_req_arg(7, 0) = i_cfg_check_pattern.read();
        ...
        case IDLESTATE_ACMD41:
            ...
            vb_cmd_req_arg(23, 0) = r.OCR_VoltageWindow.read();
    ...
    o_dat2 = v_dat2;
    o_dat3 = v_dat3;
    o_dat0_dir = r.dat_csn.read();
    o_dat1_dir = r.dat_csn.read();
    o_dat2_dir = r.dat_csn.read();
    o_dat3_dir = r.dat_csn.read();
    ...
    o_cmd_req_arg = r.cmd_req_arg.read();
    o_cmd_req_rn = r.cmd_req_rn.read();
    o_data_req_ready = v_data_req_ready;
    o_data_resp_valid = r.data_resp_valid.read();
    o_data_resp_rdata = r.data_data.read();
    o_wdog_ena = r.wdog_ena.read();
    o_err_valid = r.err_valid.read();
    o_err_clear = r.err_clear.read();
    o_err_code = r.err_code.read();
    o_400khz_ena = r.sck_400khz_ena.read();
    o_sdtype = r.sdtype.read();
}
