...
%QT_PATH64%\bin\moc.exe -i %GUI_PLUGIN_SRC%\PeriphWidgets\LedDisplay.h -o %GUI_PLUGIN_SRC%\PeriphWidgets\moc_LedDisplay.h
%QT_PATH64%\bin\moc.exe -i %GUI_PLUGIN_SRC%\PeriphWidgets\DemoM4Widget.h -o %GUI_PLUGIN_SRC%\PeriphWidgets\moc_DemoM4Widget.h
%QT_PATH64%\bin\moc.exe -i %GUI_PLUGIN_SRC%\PeriphWidgets\ButtonGenWidget.h -o %GUI_PLUGIN_SRC%\PeriphWidgets\moc_ButtonGenWidget.h
%QT_PATH64%\bin\moc.exe -i %GUI_PLUGIN_SRC%\PeriphWidgets\DemoSTM32Keypad.h -o %GUI_PLUGIN_SRC%\PeriphWidgets\moc_DemoSTM32Keypad.h
