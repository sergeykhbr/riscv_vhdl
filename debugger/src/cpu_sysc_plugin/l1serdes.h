...
#ifndef __DEBUGGER_SRC_CPU_SYSC_PLUGIN_L1SERDES_H__
#define __DEBUGGER_SRC_CPU_SYSC_PLUGIN_L1SERDES_H__
...
SC_MODULE(L1SerDes) {
    ...
    sc_in<bool> i_nrst;
    sc_out<axi4_l1_in_type> o_corei;
    sc_in<axi4_l1_out_type> i_coreo;
    ...
    SC_HAS_PROCESS(L1SerDes);

    L1SerDes(sc_module_name name, bool async_reset);
    virtual ~L1SerDes();
 ...
 private:
    ...
    static const int linew = L1CACHE_LINE_BITS;
...
#endif  // __DEBUGGER_SRC_CPU_SYSC_PLUGIN_L1SERDES_H__
