...
void CpuRiscV_RTL::createSystemC() {
    ...
    serdes_->o_corei_b_resp(corei_b_resp_i);
    serdes_->o_corei_b_id(corei_b_id_i);
    serdes_->o_corei_b_user(corei_b_user_i);
    serdes_->o_corei_ar_ready(corei_ar_ready_i);
    serdes_->o_corei_r_valid(corei_r_valid_i);
    serdes_->o_corei_r_resp(corei_r_resp_i);
    serdes_->o_corei_r_data(corei_r_data_i);
    serdes_->o_corei_r_last(corei_r_last_i);
    serdes_->o_corei_r_id(corei_r_id_i);
    serdes_->o_corei_r_user(corei_r_user_i);
    serdes_->o_corei_ac_valid(corei_ac_valid_i);
    serdes_->o_corei_ac_addr(corei_ac_addr_i);
    serdes_->o_corei_ac_snoop(corei_ac_snoop_i);
    serdes_->o_corei_ac_prot(corei_ac_prot_i);
    serdes_->o_corei_cr_ready(corei_cr_ready_i);
    serdes_->o_corei_cd_ready(corei_cd_ready_i);
    serdes_->i_coreo_aw_valid(coreo_aw_valid_o);
    serdes_->i_coreo_aw_bits_addr(coreo_aw_bits_addr_o);
    serdes_->i_coreo_aw_bits_len(coreo_aw_bits_len_o);
    serdes_->i_coreo_aw_bits_size(coreo_aw_bits_size_o);
    serdes_->i_coreo_aw_bits_burst(coreo_aw_bits_burst_o);
    serdes_->i_coreo_aw_bits_lock(coreo_aw_bits_lock_o);
    serdes_->i_coreo_aw_bits_cache(coreo_aw_bits_cache_o);
    serdes_->i_coreo_aw_bits_prot(coreo_aw_bits_prot_o);
    serdes_->i_coreo_aw_bits_qos(coreo_aw_bits_qos_o);
    serdes_->i_coreo_aw_bits_region(coreo_aw_bits_region_o);
    serdes_->i_coreo_aw_id(coreo_aw_id_o);
    serdes_->i_coreo_aw_user(coreo_aw_user_o);
    serdes_->i_coreo_w_valid(coreo_w_valid_o);
    serdes_->i_coreo_w_data(coreo_w_data_o);
    serdes_->i_coreo_w_last(coreo_w_last_o);
    serdes_->i_coreo_w_strb(coreo_w_strb_o);
    serdes_->i_coreo_w_user(coreo_w_user_o);
    serdes_->i_coreo_b_ready(coreo_b_ready_o);
    serdes_->i_coreo_ar_valid(coreo_ar_valid_o);
    serdes_->i_coreo_ar_bits_addr(coreo_ar_bits_addr_o);
    serdes_->i_coreo_ar_bits_len(coreo_ar_bits_len_o);
    serdes_->i_coreo_ar_bits_size(coreo_ar_bits_size_o);
    serdes_->i_coreo_ar_bits_burst(coreo_ar_bits_burst_o);
    serdes_->i_coreo_ar_bits_lock(coreo_ar_bits_lock_o);
    serdes_->i_coreo_ar_bits_cache(coreo_ar_bits_cache_o);
    serdes_->i_coreo_ar_bits_prot(coreo_ar_bits_prot_o);
    serdes_->i_coreo_ar_bits_qos(coreo_ar_bits_qos_o);
    serdes_->i_coreo_ar_bits_region(coreo_ar_bits_region_o);
    serdes_->i_coreo_ar_id(coreo_ar_id_o);
    serdes_->i_coreo_ar_user(coreo_ar_user_o);
    serdes_->i_coreo_r_ready(coreo_r_ready_o);
    serdes_->i_coreo_ar_domain(coreo_ar_domain_o);
    serdes_->i_coreo_ar_snoop(coreo_ar_snoop_o);
    serdes_->i_coreo_ar_bar(coreo_ar_bar_o);
    serdes_->i_coreo_aw_domain(coreo_aw_domain_o);
    serdes_->i_coreo_aw_snoop(coreo_aw_snoop_o);
    serdes_->i_coreo_aw_bar(coreo_aw_bar_o);
    serdes_->i_coreo_ac_ready(coreo_ac_ready_o);
    serdes_->i_coreo_cr_valid(coreo_cr_valid_o);
    serdes_->i_coreo_cr_resp(coreo_cr_resp_o);
    serdes_->i_coreo_cd_valid(coreo_cd_valid_o);
    serdes_->i_coreo_cd_data(coreo_cd_data_o);
    serdes_->i_coreo_cd_last(coreo_cd_last_o);
    serdes_->i_coreo_rack(coreo_rack_o);
    serdes_->i_coreo_wack(coreo_wack_o);
