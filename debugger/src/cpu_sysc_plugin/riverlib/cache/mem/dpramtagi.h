...
#ifndef __DEBUGGER_RIVERLIB_CACHE_MEM_DPRAMTAGI_H__
#define __DEBUGGER_RIVERLIB_CACHE_MEM_DPRAMTAGI_H__
...
SC_MODULE(DpRamTagi) {
    ...
    SC_HAS_PROCESS(DpRamTagi);

    DpRamTagi(sc_module_name name_);
...
#endif  // __DEBUGGER_RIVERLIB_CACHE_MEM_DPRAMTAGI_H__
