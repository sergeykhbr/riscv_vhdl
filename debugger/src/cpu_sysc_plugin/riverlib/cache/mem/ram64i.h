...
#ifndef __DEBUGGER_RIVERLIB_CACHE_MEM_RAM64I_H__
#define __DEBUGGER_RIVERLIB_CACHE_MEM_RAM64I_H__
...
SC_MODULE(Ram64i) {
    ...
    SC_HAS_PROCESS(Ram64i);

    Ram64i(sc_module_name name_);
...
#endif  // __DEBUGGER_RIVERLIB_CACHE_MEM_RAM64I_H__
