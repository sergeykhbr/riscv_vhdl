...
%QT_PATH%\bin\moc.exe -i %GUI_PLUGIN_SRC%\CpuWidgets\CodeCoverage\CodeCoverageWidget.h -o %GUI_PLUGIN_SRC%\CpuWidgets\CodeCoverage\moc_CodeCoverageWidget.h
%QT_PATH%\bin\moc.exe -i %GUI_PLUGIN_SRC%\CpuWidgets\CodeCoverage\CoverageTable.h -o %GUI_PLUGIN_SRC%\CpuWidgets\CodeCoverage\moc_CoverageTable.h
%QT_PATH%\bin\moc.exe -i %GUI_PLUGIN_SRC%\CpuWidgets\CodeCoverage\CoverageBar.h -o %GUI_PLUGIN_SRC%\CpuWidgets\CodeCoverage\moc_CoverageBar.h
...
%QT_PATH%\bin\moc.exe -i %GUI_PLUGIN_SRC%\GnssWidgets\PlotWidget.h -o %GUI_PLUGIN_SRC%\GnssWidgets\moc_PlotWidget.h
